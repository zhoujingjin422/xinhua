...
package com.xinhua.language.movieheaven.ext
...
fun <T> Context.removeSpValue(key: String, name: String = packageName) = sp(name).edit {
    remove(key)
}

fun <T> Activity.removeSpValue(key: String, name: String = packageName) = sp(name).edit {
    remove(key)
}

fun <T> Context.clearSpValue(name: String = packageName) = sp(name).edit {
    clear()
}

fun <T> Activity.clearSpValue(name: String = packageName) = sp(name).edit {
    clear()
}
